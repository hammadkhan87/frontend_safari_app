          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div className="flex items-center justify-between">
              ...
              <div className="hidden lg:flex items-center space-x-6">
                ...
                {/* CTA Button */}
                <button className="bg-[#465b2d] text-white px-6 py-3 rounded-xl font-semibold text-sm uppercase tracking-wide hover:shadow-lg transform hover:scale-105 transition-all duration-200 shadow-md hover:bg-[#3a4a24]">
                  MAKE A REQUEST
                </button>
              </div>

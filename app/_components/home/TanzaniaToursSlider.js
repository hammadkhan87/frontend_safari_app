  ...
  const tourPackages = [
    {
      days: "05 Days",
      isPrivate: true,
      title: "Tanzania Glamping Safari Experience",
      locations: ["Arusha", "Tarangire National Park", "Serengeti National Park", "Ngorongoro", "Ngorongoro Crater"],
      price: "$2383",
    ...
    },
    {
      days: "07 Days",
      isPrivate: false,
      title: "Tanzania Comfort Experience",
      locations: ["Arusha", "Tarangire National Park", "Serengeti National Park", "Ngorongoro"],
      price: "$3326",
    ...
    },
    {
      days: "09 Days",
      isPrivate: true,
      title: "Wildebeest Migration Safari",
      locations: ["Arusha", "Lake Manyara", "Serengeti National Park", "Northern Serengeti", "Central Serengeti", "Ngorongoro"],
      price: "$6239",
      image: "https://images.unsplash.com/photo-1489392191049-fc10c97e64b6?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      rating: 5.0,
      reviews: 64
    },
    {
      ...
      locations: ["Arusha", "Tarangire National Park", "Serengeti National Park", "Ngorongoro Crater"],
      price: "$2850",
    ...
    },
    {
      days: "08 Days",
      isPrivate: false,
      title: "Luxury Tanzania Adventure",
      locations: ["Arusha", "Lake Manyara", "Serengeti National Park", "Ngorongoro", "Tarangire National Park"],
      price: "$4200",
      image: "https://www.outlooktravelmag.com/media/tanzania-1-1582298839.profileImage.2x-1536x884.webp",
      rating: 4.9,
      reviews: 93
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
              ...
              >
                ...
                <div className="relative h-60 overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4 right-4 flex justify-between items-start">
                    <div className="bg-white/95 backdrop-blur-sm px-2 py-1 rounded-2xl shadow-lg">
                      <span className="font-bold text-gray-900 text-md">{tour.days}</span>
                    </div>
                    {tour.isPrivate && (
                ...
                <div className="p-2">
                  ...
                  <div className="flex flex-wrap gap-1 text-gray-600 text-sm mb-6">
                    {tour.locations.map((location, locIndex) => (
                      <span key={locIndex} className="flex items-center px-1 py-1">
                        {location}
                        {locIndex < tour.locations.length - 1 && (
          ...
          <div className="flex justify-center mt-12 space-x-3">
            {Array.from({ length: Math.ceil(tourPackages.length / visibleCards) }).map((_, index) => (
              <button
                key={index}
